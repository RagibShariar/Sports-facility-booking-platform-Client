...
const Checkout = () => {
  ...
  return (
    <>
      <div className="  p-4">
        <div className="md:max-w-6xl max-w-xl lg:h-[85vh] mx-auto flex items-center justify-center ">
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 max-md:order-1">
              <h2 className="text-3xl font-extrabold text-gray-800 dark:text-gray-50">
                Make a payment
              </h2>
              <p className="text-gray-800 text-sm mt-4 dark:text-gray-50">
              ...
              <form className="mt-8 max-w-lg">
                <div className="grid gap-4">
                  <div>
                    <input
                      ...
                      className="px-4 py-3.5 bg-gray-100 text-gray-800 w-full text-sm border rounded-md focus:border-purple-500 focus:bg-transparent outline-none dark:bg-slate-900 dark:border dark:text-gray-50"
                    />
                  </div>

                  <div className="flex bg-gray-100 border rounded-md focus-within:border-purple-500 focus-within:bg-transparent overflow-hidden dark:bg-slate-900 ">
                    <svg
                    ...
                    <input
                      ...
                      className="px-4 py-3.5 text-gray-800 w-full text-sm outline-none bg-transparent dark:bg-slate-900 dark:border dark:text-gray-50 dark:border-none"
                    />
                  </div>
                ...
                <button
                  type="button"
                  className="bg-gradient mt-8 w-40 py-3.5 text-sm text-white rounded-md hover:bg-purple-600 tracking-wide"
                >
                  Pay{" "}
                </button>
              </form>
